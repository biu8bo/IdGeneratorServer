...
public class DistributedSupportWithRedis : IDistributedGeneratorSupport,ISingletonDependency
{
    ...
    public async Task<ushort> GetNextWorkId()
    {
        ...
        return ushort.Parse(_workId.ToString());
    }
